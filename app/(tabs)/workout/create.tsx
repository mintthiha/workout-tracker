  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <TextInput
          style={[styles.nameInput, { backgroundColor: inputBg, color: textColor, borderColor: cardBorder }]}
          value={templateName}
          ...
          >
            ...
            <View style={styles.fieldsRow}>
              ...
              <FieldInput
                ...
                onChange={(v) => updateEntry(entry.exerciseId, { defaultWeight: v })}
                inputBg={inputBg}
                textColor={textColor}
                secondaryText={secondaryText}
                borderColor={cardBorder}
      ...
      <Modal visible={showPicker} animationType="slide" presentationStyle="pageSheet">
        <View style={[styles.pickerContainer, { backgroundColor: bgColor }]}>
          ...
          <TextInput
            style={[styles.searchInput, { backgroundColor: cardBg, color: textColor, borderColor: cardBorder }]}
            value={searchQuery}
              ...
              <View>
                ...
                {item.exercises.map((ex) => {
                  ...
                  return (
                    <TouchableOpacity
                      key={ex.id}
                      style={[styles.pickerItem, { borderBottomColor: cardBorder }]}
                      onPress={() => addExercise(ex)}
                      disabled={alreadyAdded}
                    >
                      <ThemedText
                        style={[styles.pickerItemName, alreadyAdded && { color: secondaryText }]}
                      >
                        {ex.name}
                      </ThemedText>
                      {alreadyAdded && (
